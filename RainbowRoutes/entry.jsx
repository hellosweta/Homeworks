  ...
  render() {
    return(
      <div>
        ...
        <h4 style={{cursor: 'pointer'}} onClick={this.addRed}>Red</h4>
        <h4 style={{cursor: 'pointer'}} onClick={this.addGreen}>Green</h4>
        <h4 style={{cursor: 'pointer'}} onClick={this.addBlue}>Blue</h4>
        <h4 style={{cursor: 'pointer'}} onClick={this.addViolet}>Violet</h4>
